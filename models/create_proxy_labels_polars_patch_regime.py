...
if __name__ == "__main__":
    ...
    # ※インタラクティブモードの実装は前回コードと同様のため、ここでは非対話型の引数処理のみを抜粋
    filter_mode_arg = args.filter_mode if args.filter_mode else "all"
    filter_year_arg = args.year
    filter_month_arg = None

    if filter_mode_arg == "month" and args.year_month:
