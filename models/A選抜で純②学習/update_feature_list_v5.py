...
def create_updated_feature_list(source_file: Path, output_file: Path):
    ...
    try:
        ...
        non_feature_cols = {
            ...
            "high",
            "low",
            "close_future",  # label_B錨用の一時列（生の未来価格。特徴量化厳禁）
            "e1c_atr_13_M1",
        ...
        # [入れ子メタラベリング] ラベル/duration/uniqueness/concurrency 系の接頭辞ガード。
        # label_A_long, label_B_short, duration_A_*, uniqueness_B_* 等の新カラムが
        # 学習特徴量に漏れ込む（＝未来情報リーク）のを、個別列挙に依存せず一括で塞ぐ。
