...
TRIGGER_AMP_MULTIPLIER = 0.88

# 2. Lockout (Brake)
# 【修正】バランス型（竹）の設定
# 極端な数値のみ弾き、学習に必要なボラティリティは確保する
LOCKOUT_RULES = {
    # 歪度: -5.0 -> -2.0 (通常の調整は許容、クラッシュのみ弾く)
    "skewness": {"col": "e1a_statistical_skewness_20", "thresh": -1.52, "op": "lt"},
    # 尖度: 20.0 -> 12.0 (ファットテールを許容しつつ、異常値は弾く)
    "kurtosis": {"col": "e1a_statistical_kurtosis_20", "thresh": 100.0, "op": "gt"},
    ...
    "body_ratio": {"col": None, "thresh": 0.95, "op": "gt"},
}
...
class ProxyLabelingEngine:
    ...
    def _generate_report(self):
        ...
        report_filename = "execution_report_regime_v5.md"
