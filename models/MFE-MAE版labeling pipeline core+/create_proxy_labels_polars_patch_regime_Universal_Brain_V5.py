...
RULE_LONG = {
    ...
    "sl_mult": 0.5,  # sl_multiplier_long
    "td": "6m",  # td_minutes_long: 30
}

# ショート用ルール
RULE_SHORT = {
    "pt_mult": 1.0,  # pt_multiplier_short
    "sl_mult": 0.5,  # sl_multiplier_short
    "td": "6m",  # td_minutes_short: 30
}
# --- ▲▲▲ 改造ここまで ▲▲▲ ---
        ...
        for timeframe_tuple, group_df in daily_bets_df.group_by("timeframe"):
            ...
            calculated_df = (
                ...
                .with_columns(
                    ...
                    mfe_usd=(pl.col("_mfe_max_mid") - pl.col("close"))
                    .cast(pl.Float32)
                    .fill_nan(None),
                    mae_usd=(pl.col("close") - pl.col("_mae_min_mid"))
                    .cast(pl.Float32)
                    .fill_nan(None),
                )
                .with_columns(
