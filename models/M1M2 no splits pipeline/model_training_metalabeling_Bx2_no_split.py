...
class MetaLabelGenerator:
    ...
    def run(self) -> None:
        ...
        for direction in ["long", "short"]:
            ...
            # [(い) 直交分割なし版] M2 も全特徴量を読み込む
            # (旧: S3_SELECTED_FEATURES_ORTHOGONAL_DIR / m2_{direction}_features.txt)
            # m1_pred_proba はS6には無く後段でjoinされるため、下で除外する（既存挙動）。
            dedicated_path = S3_FEATURES_FOR_TRAINING_V5
