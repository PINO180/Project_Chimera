...
# 【修正要件4】 保存ファイル名をショート用に変更
RESULTS_CSV_PATH = Path(
    "/workspace/data/XAUUSD/stratum_7_models/1A_2B/optuna_top100_pure_atr_results_short.csv"
)
...
def run_optimization():
    ...
    for target_tf in SEARCH_TIMEFRAMES:
        ...
        logging.info(
            f"=== Starting Optuna Optimization for {target_tf} [SHORT_ONLY] (Trials: {N_TRIALS}) ==="
        )
