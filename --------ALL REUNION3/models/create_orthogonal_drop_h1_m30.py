"""
create_orthogonal_drop_h1_m30.py

selected_features_orthogonal_v5 の4ファイルから
H1とM30を削除し、同ディレクトリ内の orthogonal_drop_h1_m30/ に出力する。

■ 削除ルール（全4ファイル共通）
  H1 / M30 を削除 → M0.5 / M1 / M3 / M5 / M8 / M15 を残す
...
SRC_DIR    = BASE_DIR
OUTPUT_DIR = BASE_DIR / "orthogonal_drop_h1_m30"

REMOVE_SUFFIXES = {"_H1", "_M30"}
