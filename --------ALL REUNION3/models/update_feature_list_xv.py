...
from blueprint import S6_WEIGHTED_DATASET, S3_FEATURES_FOR_TRAINING_XV
...
# 出力する新しい特徴量リストのパス
new_feature_list_path = S3_FEATURES_FOR_TRAINING_XV
...
def create_updated_feature_list(source_file: Path, output_file: Path):
    ...
    try:
        ...
        non_feature_cols = {
            ...
            "timeframe",
            # --- V5 必須メタデータ ---
            "is_trigger",       # エントリータイミングのフラグ（共通）
            "is_trigger_long",  # ★XV追加: Long個別ATR閾値フラグ
            "is_trigger_short", # ★XV追加: Short個別ATR閾値フラグ
