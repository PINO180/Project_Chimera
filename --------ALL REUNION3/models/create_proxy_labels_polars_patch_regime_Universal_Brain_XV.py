...
# 対象タイムフレームとATRの指定
TARGET_TIMEFRAMES = ["M0.5"]  # Optunaの結論: M0.5単体・ratio1.2・TD30min
ATR_PERIOD = BARRIER_ATR_PERIOD  # blueprintから取得
ATR_RATIO_THRESHOLD = 1.2  # ATR Ratio閾値（絶対値ではなく相対比率）
...
# ロング用ルール
RULE_LONG = {
    "pt_mult": 2.5,  # pt_multiplier_long
    "sl_mult": 10.0,  # sl_multiplier_long
    "td": "30m",  # td_minutes_long: 30
}

# ショート用ルール
RULE_SHORT = {
    "pt_mult": 2.5,  # pt_multiplier_short
    "sl_mult": 10.0,  # sl_multiplier_short
