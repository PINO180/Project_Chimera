...
class BacktestConfig:
    ...
    min_atr_threshold: float = 1.2  # M0.5・atr_threshold=1.2
    ...
    # ==========================================
    sl_multiplier_long: float = 10.0
    pt_multiplier_long: float = 2.5
    sl_multiplier_short: float = 10.0
    pt_multiplier_short: float = 2.5
