...
class FinalAssembler:
    def __init__(self, config: FinalTrainingConfig):
        ...
        # ▼▼▼ 修正: 検証1 (M2から m1_pred_proba を除外) ▼▼▼
        # 元の実験コード: self.features_m2: List[str] = ["m1_pred_proba"] + self.top_50_features
        # 今回の修正: m1_pred_proba を削除し、純粋な Top 50 のみにする
        self.features_m2: List[str] = self.top_50_features
        # ▲▲▲ 修正ここまで ▲▲▲
